...
-- card_size: '1x1' (compact), '2x1' (standard/default), '2x2' (large)
...
-- Comment for clarity
COMMENT ON COLUMN services.card_size IS 'Card display size: 1x1 (compact), 2x1 (standard/default), 2x2 (large)';
